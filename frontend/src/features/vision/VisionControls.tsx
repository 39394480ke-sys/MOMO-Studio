    ...
    <aside className="vision-controls" aria-label="视觉控制">
      <section className="vision-control-card">
        <div className="vision-control-card__heading">
          ...
          <div><p className="eyebrow">访问边界</p><h2>图像源与策略</h2></div>
        </div>
      ...
      <section className="vision-control-card">
        <div className="vision-control-card__heading">
          ...
          <div><p className="eyebrow">目标</p><h2>选择与检测</h2></div>
        </div>
      ...
      <section className="vision-control-card">
        ...
        <div className="vision-follow-grid">
          ...
          <NumericControl disabled={tuningDisabled} label="最大单步" min={0.1} max={10} step={0.1} value={workspace.configuration.max_step} onChange={(value) => updateNumber(workspace, 'max_step', value)} />
          <NumericControl disabled={tuningDisabled} label="最大速率" min={0.2} max={20} step={0.1} value={workspace.configuration.max_rate} onChange={(value) => updateNumber(workspace, 'max_rate', value)} />
        </div>
