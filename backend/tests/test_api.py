...
def test_stage_eight_exposes_reviewed_api_and_read_only_websocket() -> None:
    ...
    assert api_paths == {
        ...
        "/api/v1/device/commissioning/joints/{joint_id}/direct/step": frozenset({"post"}),
        "/api/v1/device/commissioning/joints/{joint_id}/direct/jog/start": frozenset({"post"}),
        "/api/v1/device/commissioning/joints/{joint_id}/tests/start": frozenset({"post"}),
        "/api/v1/device/commissioning/direct/jog/status": frozenset({"get"}),
        "/api/v1/device/commissioning/direct/jog/heartbeat": frozenset({"post"}),
        "/api/v1/device/commissioning/direct/jog/release": frozenset({"post"}),
        "/api/v1/device/commissioning/direct/jog/stop": frozenset({"post"}),
        "/api/v1/device/commissioning/direct/joints/state": frozenset({"get"}),
        "/api/v1/device/commissioning/raw-direction/heartbeat": frozenset({"post"}),
        "/api/v1/device/commissioning/raw-direction/draft/confirm": frozenset({"post"}),
        "/api/v1/device/commissioning/raw-direction/joints/{joint_id}/arm": frozenset({"post"}),
        "/api/v1/device/commissioning/raw-direction/joints/{joint_id}/alignment": frozenset(
            {"post"}
        ),
        "/api/v1/device/commissioning/raw-direction/joints/{joint_id}/step": frozenset({"post"}),
        "/api/v1/device/commissioning/raw-direction/session": frozenset({"post"}),
        "/api/v1/device/commissioning/raw-direction/status": frozenset({"get"}),
        "/api/v1/device/commissioning/raw-direction/stop": frozenset({"post"}),
        ...
        "/api/v1/kinematics/fk": frozenset({"post"}),
        ...
        "/api/v1/motion/cartesian-jog/start": frozenset({"post"}),
        "/api/v1/motion/cartesian-jog/{session_id}/heartbeat": frozenset({"post"}),
